...
up: ## Dockerコンテナを起動
	...
	@echo "🌐 アプリケーション: http://localhost:18080"
	@echo "📊 phpMyAdmin: http://localhost:18081"
	@echo "🗄️  MySQL: localhost:13306 (ユーザー: stamp_user, パスワード: stamp_pass)"
...
setup: up install key-generate migrate seed ## 初回セットアップ（推奨）
	@echo ""
	@echo "🎉 セットアップが完了しました！"
	@echo ""
	@echo "📖 次のステップ:"
	@echo "   1. http://localhost:18080 でアプリケーションにアクセス"
	@echo "   2. 管理者パスワードを設定"
...
health: ## ヘルスチェック
	...
	@curl -f http://localhost:18080 >/dev/null 2>&1 && echo "✅ アプリケーション: 正常" || echo "❌ アプリケーション: 異常"
